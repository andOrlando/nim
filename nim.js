    ...
    if (nim_sum == 0) {
        ...
        for(let i = 0; i < heaps.length; i++) 
        {
            ...
            for(let r = 1; r < heaps[i]; r++) {
                ...
                if (calculate_num_0_nim_sum_moves(heaps) < lowest_num_optimal_moves) {
                    lowest_num_optimal_moves = calculate_num_0_nim_sum_moves(heaps);
                    best_move = {
                        row: i,
                        removals: r
                    } 
...
console.log(calculate_next_move([7,5,3,1]))
console.log(calculate_num_0_nim_sum_moves([1,5,3,1]))
for(let i = 0; i < 7; i++) {
    console.log(`${i}: ${calculate_num_0_nim_sum_moves([i, 5, 3, 1])}`)
}
console.log('\n');
console.log(calculate_num_0_nim_sum_moves([6, 5,3,1]))